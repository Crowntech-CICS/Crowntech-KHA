        ...
        <div class="main-body">
            <div class="signup-box-big">
                ...
                <form id='form1'>
                    ...
                    <input onchange="finalForm.HO_LANDLINE.value = this.value" type="text" name="HO_LANDNO" placeholder="Landline Number" class="form-medium" id="form-margin-medium"><input onchange="finalForm.HO_PHONE.value = this.value" type="text" name="HO_MOBNO" placeholder="Mobile Number" class="form-medium"><br>
                    <br><br><br><br>
                ...
                <form id="form3">
                    ...
                    <input onchange="finalForm.TIT_SURNUM.value = this.value" type="text" name="TIT_SURNOM" placeholder="Survey No." class="form-medium" id="form-margin-medium"><input onchange="finalForm.TIT_LOTNUM.value = this.value" type="text" name="TIT_LOTNUM" placeholder="Lot No."  class="form-medium"><br>
