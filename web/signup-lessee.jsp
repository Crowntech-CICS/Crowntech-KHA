...
<head>
    ...
    <title>Lessee Registration Form | Kingsville Homeowner Association</title>
</head>
<body>
    <header>
        <nav> 
    ...
    <h1 class="center">Lessee Registration</h1>
    <div class="form-box-lessee">
    <form action="">
        <div class="basic_info" id="form_container">
            <h1>Lessee Information</h1><br>
        ...
        <div class="contact_info" id="form_container">
            <h1>Lessee Contact Information</h1><br>
